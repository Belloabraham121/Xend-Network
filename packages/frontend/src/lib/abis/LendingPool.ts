export const LendingPoolABI = [
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct LendingPool.LoanInfo",
        "components": [
          {
            "name": "loanId",
            "type": "uint256",
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct LendingPool.PoolInfo",
        "components": [
          {
            "name": "totalDeposits",
            "type": "uint256",
  ...
  {
    "type": "error",
    "name": "RepaymentAmountExceedsDebt",
    "inputs": [
      {
        "name": "amount",
        "type": "uint256",
