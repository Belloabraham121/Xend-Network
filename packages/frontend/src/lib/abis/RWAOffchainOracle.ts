export const RWAOffchainOracleABI = [
  {
    "type": "constructor",
    "inputs": [
      {
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct RWAOffchainOracle.RWAMarketData",
        "components": [
          {
            "name": "marketCap",
            "type": "uint256",
